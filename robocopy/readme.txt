...
## The robocopy_continuous-upload.bat will upload data continuously, and create a log in the same parent folder to monitor success. This does not requrie the automatic task scheduler setup in Windows, but is rather a batch script ran directly. 
